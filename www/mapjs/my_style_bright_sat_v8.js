  ...
  "sources": {
    "mapbox": {
      ...
      //  "tiles": ["http://192.168.0.20/tiles/{z}/{x}/{y}.pbf"],
        "tiles": ["http://acharger.ca/tiles/{z}/{x}/{y}.pbf"],
      "minzoom": 1,
      "maxzoom": 14
    ...
    "satelliteSrc": {
             ...
             // "tiles": ["https://api.mapbox.com/v4/mapbox.satellite/{z}/{x}/{y}.webp?access_token=pk.eyJ1Ijoic2t1bHlrb3YiLCJhIjoiY2l4dnpkdWFlMDAxNjJxbzdiY3UwcDB1cSJ9.Z2e99vwl0pHnz7bvwcTr9Q"],
        "tiles": ["http://acharger.ca/sat/{z}/{x}/{y}.webp"],
             // "tiles": ["http://localhost/sat/{z}/{x}/{y}.webp"],
              "minzoom": 1,
              "maxzoom": 20,
              "tileSize": 256
          }
...
// motorway link 
    ...
    //shield roads
      //shield roads -> major=2
      {
          ...
          "type": "symbol",
          "source": "mapbox",
          "id": "road_label_highway_shield_1",
          "paint": {},
          "source-layer": "road_label"
      },
