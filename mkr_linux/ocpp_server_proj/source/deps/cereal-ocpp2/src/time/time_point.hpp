...
public:
        ...
        : nanos_since_epoch_(0)
    {
        ...
        {
#ifndef WIN32   
			// on windows it does not show a correct time  -- Not sure why ??
...
#else
			nanos_since_epoch_ =std::chrono::duration_cast<std::chrono::nanoseconds>(std::chrono::system_clock::now().time_since_epoch()).count();
#endif
        }
    }
