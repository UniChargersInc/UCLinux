...
/*In most cases, modern SMTP email clients (Microsoft Outlook, Mail, Thunderbird, etc.) shouldn't use this port*/
#define SMTP_CLIENT_PORT	25

/*This is the default mail submission port. When an email client or server is submitting an email to be routed by a proper mail server, 
it should always use SMTP port 587 as the default port.*/
//#define SMTP_CLIENT_PORT	587
...
public:
	...
	ECSmtp(CSmtpError err_,const char *desc="") : ErrorCode(err_),description(desc) {}
