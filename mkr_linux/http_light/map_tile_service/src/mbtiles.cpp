...
MBTiles::MBTiles() { open_flag = false; }
...
bool MBTiles::readTile(int z, int x, int y, std::vector<char> &OutV)
{
	char buf[256];
...
#else
void MBTiles::saveTile(int tid, string *data) {
...
bool MBTiles::readTile(int tid, std::vector<char> &OutV)
{
	char buf[256];
